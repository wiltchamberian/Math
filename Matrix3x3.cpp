...
namespace Sun
{
    ...
    Vector3D Matrix3x3::getRow(int position) const
    {
        switch (position)
        {
        case 0:
            return Vector3D(entries[0], entries[1], entries[2]);
        case 1:
            return Vector3D(entries[3], entries[4], entries[5]);
        case 2:
            return Vector3D(entries[6], entries[7], entries[8]);
        }
        return Vector3D(0.0f, 0.0f, 0.0f);
    }

    Vector3D Matrix3x3::getColumn(int position) const
    {
        switch (position)
        {
        case 0:
            return Vector3D(entries[0], entries[3], entries[6]);
        case 1:
            return Vector3D(entries[1], entries[4], entries[7]);
        case 2:
            return Vector3D(entries[2], entries[5], entries[8]);
        }
        return Vector3D(0.0f, 0.0f, 0.0f);
    }
    ...
    Matrix3x3 Matrix3x3::getScale(const Vector3D& scaleFactor)
    {
        Matrix3x3 m;
    ...
    Matrix3x3 Matrix3x3::getRotationAxis(const double radians, const Vector3D& axis)
    {
        Matrix3x3 m;
